...
def main() -> None:
    ...
    parser.add_argument("stage", choices=STAGES); parser.add_argument("--data-root", type=Path, default=Path("data/raw/dfl")); parser.add_argument("--output-root", type=Path, default=Path("data/processed/pivot-v1")); parser.add_argument("--config", type=Path, default=Path("config/zcpv_v1.json")); parser.add_argument("--app-output", type=Path, default=Path("app/research-v1.generated.ts")); parser.add_argument("--match"); parser.add_argument("--include-tracking", action="store_true")
