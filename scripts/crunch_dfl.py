...
def main():
    ...
    parser.add_argument('--output',type=Path,default=Path('app/match-data.generated.ts'))
    parser.add_argument('--xt-grid',type=Path,default=Path('data/processed/models/xt_grid.npy'),help='Trained fine-grid xT model; falls back to the seven-match DFL fit when absent')
    ...
    if args.output.suffix == '.ts':
        serialized=f'// Generated by scripts/crunch_dfl.py. Do not edit by hand.\nconst matchData = {serialized};\nexport default matchData;\n'
