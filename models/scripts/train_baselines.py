...
def main() -> None:
    ...
    parser.add_argument("--data", type=Path, default=DATA_ROOT / "raw" / "statsbomb")
    parser.add_argument("--output", type=Path, default=FRONTEND_ROOT / "app" / "model-report.generated.ts")
    parser.add_argument("--model-dir", type=Path, default=DATA_ROOT / "processed" / "models")
    ...
    args.output.write_text(f"// Generated by models/scripts/train_baselines.py.\nconst modelReport = {serialized};\nexport default modelReport;\n", encoding="utf-8")
